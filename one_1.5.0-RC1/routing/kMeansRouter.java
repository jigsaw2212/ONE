...
public class kMeansRouter extends ActiveRouter{
   ...
   /* sumEncounters of total encounters by every node*/
    ...
    public double[] deNormalise = new double[4];
...
//           System.out.println("no. of connections="+getConnections().size());
            ...
            for (Connection con : getConnections()){
             ...
             //   System.out.println("other:: "+other.getAddress());
               ...
               //  System.out.print("x");
                ...
                featureMatrix[i][2]=other.getBufferOccupancy()*1e-6;
               ...
               // System.out.println(msgSuccess[other.getAddress()]);
                ...
                //System.out.println(featureMatrix[i][0] + " " + featureMatrix[i][1] + " " + featureMatrix[i][2] + 
                  //  " " + featureMatrix[i][3]);
        ...
        //  preproc.init(feats_train);
            ...
            System.out.println(getsumEncounters(dest));
            System.out.println(totalDelivered);
            System.out.println(result);


            for(int x=0; x < getConnections().size(); x++)
            {   
                System.out.println(featureMatrix[x][0] + " " + featureMatrix[x][1] + " " + featureMatrix[x][2] + 
                " " + featureMatrix[x][3]);      
            }

            //De-Normalizing cluster center values
            /*
            for (int x=0;x<k;x++) {

                for(int y=0; y<noOfFeatures; y++)
                {
                    cluster_centers.put(x,y) = cluster_centers.get(x,y)*deNormalise[y];
                }
            }
            */
            ...
            for (int x=0;x<k;x++) {
                ...
                double temp = java.lang.Math.pow((cluster_centers.get(x,0)*deNormalise[0] - getsumEncounters(dest)),2)+java.lang.Math.pow((cluster_centers.get(x,1)*deNormalise[1] - 0.0),2)+
                    java.lang.Math.pow((cluster_centers.get(x,2)*deNormalise[2] - 50.0),2)+java.lang.Math.pow((cluster_centers.get(x,3)*deNormalise[3]-totalDelivered),2);
