...
import report.TotalEncountersReport;
...
public class GameRouter extends ActiveRouter {
	...
	private Map<DTNHost, Double> Alpha;
	private Map<DTNHost, Double> Beta;
	private Map<DTNHost, Double> Gamma;
	...
	private void initAlpha() {
		this.Alpha = new HashMap<DTNHost, Double>();
	}
	
	/**
	 * Initializes beta hash
	 */
	private void initBeta() {
		this.Beta = new HashMap<DTNHost, Double>();
	}

	
	/**
	 * Initializes gamma hash
	 */
	...
	public int[] getEncounter(){
		TotalEncountersReport totalObject = new TotalEncountersReport();
		int [] totalEncounters=totalObject.getEncounters();
